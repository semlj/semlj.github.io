...
In case more information about the model is required, the `r opt("Output options")` provides options for that. Here we select `r opt("R-squared")` `r opt("Endogenous")` to get the $R^2$ of the model, as shown in the figure.
