...
To obtain a standard SEM model, please be sure that the observed variables are marked as `continuous variable` in the dataset. You see a little _ruler_ icon at the left of the variable name, like this:
